      ...
      var l =
        ...
        g = function(e) {
          var t,
            ...
            r = [],
            i = [],
            o = u.default.Children.count(e.children),
            s = (0, f.lazyStartIndex)(e),
            a = (0, f.lazyEndIndex)(e);
          return (
            u.default.Children.forEach(e.children, function(c, d) {
              var g = void 0,
                S = {
                  message: "children",
                  index: d,
              ...
              if (
                (n.push(
                  u.default.cloneElement(g, {
                    key: "original" + y(g, d),
                    "data-index": d,
                    className: (0, p.default)(b, m),
                    tabIndex: "-1",
                    "aria-hidden": !b["slick-active"],
                    style: l({ outline: "none" }, g.props.style || {}, w, {
                      width: "calc(100% / " + e.children.length + ")"
                    }),
                    onClick: function(t) {
        ...
        return (
          ...
          (t.prototype.render = function() {
            var e = g(this.props),
              ...
              i = t.onMouseLeave,
              o = t.trackStyle,
              s = { onMouseEnter: n, onMouseOver: r, onMouseLeave: i };
            return u.default.createElement(
              "div",
              l(
                {
                  className: "slick-track",
                  style: l({}, o, { width: "calc(100% * " + e.length + ")" })
                },
                s
              ),
              e
